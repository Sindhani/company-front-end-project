            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="mb-3 mb-lg-0"><a href="javascript:;" class="btn btn-sm btn-link"><i
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Experience"><span
                                    class="p-tab-name">Experience</span><i
                                    class='bx bx-donate-blood font-24 d-sm-none'></i></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" id="profile-tab" data-toggle="tab" href="#Biography"><span
                        ...
                        <div class="card shadow-none border mb-0 radius-15">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center mb-3">
                                    ...
                                    <p class="mb-0 ml-sm-3 text-muted">3 Job History</p> <a href="javascript:;"
                                                                                            class="btn btn-primary ml-auto radius-10"><i
                                ...
                                <div class="media"><i class='bx bxl-dribbble media-icons bg-dribbble'></i>
                                    <div class="media-body ml-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <h5 class="text-muted mb-0"><i class='bx bx-time'></i> Feb-2017-Dec-2017
                                                </h5>
                                            </div>
                                            <div class="col-lg-4">
                                                <h5 class="text-muted mb-0"><i class='bx bxs-map'></i> New York, USA
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-3">
                                                <img src="https://via.placeholder.com/800x500" class="img-thumbnail"
                                                     alt="">
                                            </div>
                                            <div class="col-12 col-lg-3">
                                                <img src="https://via.placeholder.com/800x500" class="img-thumbnail"
                                ...
                                <div class="media"><i class='bx bxs-diamond media-icons bg-warning'></i>
                                    <div class="media-body ml-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <h5 class="text-muted mb-0"><i class='bx bx-time'></i> Apr-2011-Sep-2013
                                                </h5>
                                            </div>
                                            <div class="col-lg-4">
                                                <h5 class="text-muted mb-0"><i class='bx bxs-map'></i> Sydney, Australia
                                                </h5>
                                            </div>
                                        </div>
                                        <p class="mt-2">It is a long established fact that a reader will be distracted
                            ...
                            <div class="col-lg-4">
                                <div class="card shadow-none border mb-0">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <p class="mb-0"><i class='bx bx-images'></i> Portfolio: <a
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item"><i
                                                        class="flag-icon flag-icon-um mr-2"></i><span>English</span>
                                            </li>
                                            <li class="list-inline-item"><i
                                                        class="flag-icon flag-icon-fr mr-2"></i><span>French</span>
                                            </li>
                                            <li class="list-inline-item"><i
                                                        class="flag-icon flag-icon-de mr-2"></i><span>German</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12 col-lg-5 border-right">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" value="{{auth()->check() ? auth()->user()->name: '...'}}" class="form-control"
                                                    name="name">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" readonly value="{{auth()->check() ? auth()->user()->email : '....'}}"
                                                       class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Phone</label>
                                            ...
                                            <div class="form-group">
                                                <label>Address</label>
                                                <input type="text" value="116-B, Cutela Colony, Sydney, Australia"
                                                       class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Nation</label>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           value="https://twitter.com/anyukova">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Linked In</label>
                                                    <input type="text" class="form-control"
                                                           value="https://www.linkedin.com/anyukova/">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           value="https://www.facebook.com/anyukova">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Dribbble</label>
                                                    <input type="text" class="form-control"
                                                           value="https://dribbble.com/anyukova/">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Slogan</label>
                                                <input type="text" class="form-control"
                                                       value="Land Acquisition Specialist">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="card shadow-none border mb-3 mb-md-0">
                                                            <div class="card-body">
                                                                <div class="media align-items-center">
                                                                    <img src="assets/images/icons/credit-card-visa.png"
                                                                         width="50" alt="">
                                                            ...
                                                            <div class="card-footer bg-transparent text-right"><a
                                                                        href="javascript:;"
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="card shadow-none border mb-0">
                                                            <div class="card-body">
                                                                <div class="media align-items-center">
                                                                    <img src="assets/images/icons/mastercard-2.png"
                                                                         width="50" alt="">
                                                                    <div class="media-body ml-2">
